...
function getQuote () {
  $.ajax({
    headers: {
      ...
      "X-Mashape-Key": "apbsxzQFyLmsh0stbQpX401CdZkRp1sJqNFjsnNkaMafuBWza1",
    ...
    success: function (response) {
      ...
      // calls the functioin that displays the quote on the page, and passes the quote object as an argument
...
function setQuoteText (quoteObject) {
  // uses jquery to select and set the html of the quote and author fields
